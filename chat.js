export async function handler(event) {
  ...
  const response = await fetch("https://api.openai.com/v1/chat/completions", {
    ...
    body: JSON.stringify({
      ...
      messages: [
        { role: "system", content: `
Du bist ein freundlicher und kompetenter KI-Chatbot von Fairprint Solutions. Antworte auf Fragen basierend auf diesen Informationen:
...
- Unter 'Drucker-Leasing' wird erläutert, dass Kunden modernste Geräte zu planbaren Raten erhalten, inklusive Service.
